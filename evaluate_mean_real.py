...
if opt.data == 'real_test':
    result_dir = './results/6D-ViT_results/real_test'
...
def evaluate():
    ...
    # load spd results
    pkl_spd_path = os.path.join('./results/spd_results/real_test', 'mAP_Acc.pkl')
    ...
    pkl_path = os.path.join('./results/nof_results', opt.data, 'mAP_Acc.pkl')
    with open(pkl_path, 'rb') as f:
